...
function SearchBar(props) {
    // Initialize jobCriteria with default values if props.filterValues is undefined
    const [jobCriteria, setJobCriteria] = useState({
        title: props.filterValues?.title || "",
        location: props.filterValues?.location || "",
        experience: props.filterValues?.experience || "",
        type: props.filterValues?.type || ""
    });

    useEffect(() => {
        // Update jobCriteria if filterValues changes
